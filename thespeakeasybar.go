...
type SDKOption func(*TheSpeakeasyBar)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *TheSpeakeasyBar) {
...
func New(opts ...SDKOption) *TheSpeakeasyBar {
	sdk := &TheSpeakeasyBar{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			...
			SDKVersion:        "0.4.0",
			GenVersion:        "2.250.2",
			UserAgent:         "speakeasy-sdk/go 0.4.0 2.250.2 1.0.0 github.com/speakeasy-sdks/test-ryan-3",
			ServerDefaults: map[string]map[string]string{
				"prod":    {},
				"staging": {},
				"customer": {
